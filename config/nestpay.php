...
return [
    ...
    'merchant' => [
        ...
        '3DGateUrl' => env('NESTPAY_MERCHANT_3D_GATE_URL', 'https://entegrasyon.asseco-see.com.tr/fim/est3Dgate'),
        
        //API
        'apiName' => env('NESTPAY_MERCHANT_API_USERNAME', ''),
        'apiPassword' => env('NESTPAY_MERCHANT_API_PASSWORD', ''),
        'apiEndpointUrl' => env('NESTPAY_MERCHANT_API_ENDPOINT_URL', 'https://entegrasyon.asseco-see.com.tr/fim/api'),
    ],
